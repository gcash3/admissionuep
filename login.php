    ...
    if (!$dbcheck->connected) {
        ...
        if ($continue) {
            ...
            if (is_array($employee) && count($employee)) {
              ...
              header("Set-Cookie: adminportal=$key; path=/; HttpOnly"); // setcookie not working if page is redirected
  ...
  <div class="login-box-body">
    ...
    <form method="post" autocomplete="off" id="f">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Username" name="p" id="p" required="required" maxlength="10" value="<?php //echo $username; ?>" autofocus>
