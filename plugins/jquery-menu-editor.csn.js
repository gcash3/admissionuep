...
function MenuEditor(idSelector, options) {
    ...
    function TButtonGroup() {
        ...
        var $btnUp = TButton({classCss: 'btn btn-default btn-xs btnUp btnMove', text: '<i class="fa fa-chevron-up clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-default btn-xs btnDown btnMove', text: '<i class="fa fa-chevron-down clickable"></i>'});
        var $btnOut = TButton({classCss: 'btn btn-default btn-xs btnOut btnMove', text: '<i class="fa fa-chevron-left clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-default btn-xs btnIn btnMove', text: '<i class="fa fa-chevron-right clickable"></i>'});
        var $btnEdit2 = TButton({classCss: 'btn btn-default btn-xs btnEdit', text: '<i class="fa fa-pencil clickable"></i>'});
        $divbtn.append($btnEdit2).append($btnUp).append($btnDown).append($btnIn).append($btnOut).append($btnEdit).append($btnRemv);
        return $divbtn;
    }
